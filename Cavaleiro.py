...
class Cavaleiro(Personagem):
    def hab_especial(array, array2, personagem_da_vez):
        ...
        for personagem_atacado1 in array:
            personagem_atacado1.pontos_vidas = personagem_atacado1.pontos_vidas - \
                5 * personagem_da_vez.pontos_ataque
        for personagem_atacado2 in array:
            personagem_atacado2.pontos_vidas = personagem_atacado1.pontos_vidas - \
                5 * personagem_da_vez.pontos_ataque
